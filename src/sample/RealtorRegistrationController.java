...
public class RealtorRegistrationController {
    ...
    void initialize() {
        ...
        registration_id.setOnAction(event -> registrationRealtor());
        exit.setOnAction(event -> returnAuthorization(event));
    }
    private void registrationRealtor() {
        ...
        boolean registrationSuccessful = dbHandler.signUpRealtor(name, surname, age, address, phone, email, login, password, gender);
